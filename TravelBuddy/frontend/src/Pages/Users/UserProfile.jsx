                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  <div>
                    ...
                    <div className="flex items-center text-gray-600">
                      ...
                      <span className="capitalize font-medium text-purple-600">{user.role}</span>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                      ...
                      <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <div className="font-medium">{getTimeSinceJoined(user.createdAt)}</div>
                        </div>
                      </div>
                      {user.dateOfBirth && (
                        <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="space-y-3">
                      {user.languages.map((lang, index) => (
                        ...
                        >
                          ...
                          <span className={`px-3 py-1 rounded-full text-xs font-medium ${getProficiencyColor(lang.proficiency)}`}>
            ...
            {activeTab === 'destinations' && (
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {user.futureDestinations && user.futureDestinations.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-gray-400 mb-6">
                      Add your future destinations to connect with travelers going to the same places
                    </p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Receive updates about your travels</div>
                      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                ...
                {user.currentLocation && (user.currentLocation.lat || user.currentLocation.lng) && (
                  <div className="flex items-center justify-between">
            ...
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-6 text-white">
              <h3 className="text-lg font-semibold mb-2">Connect with Travelers</h3>
